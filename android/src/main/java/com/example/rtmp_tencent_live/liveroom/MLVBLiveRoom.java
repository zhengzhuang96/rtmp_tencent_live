...
public abstract class MLVBLiveRoom {
     ...
     */
    public abstract void createRoom(final String roomID, final String roomInfo, final String pushURL, final IMLVBLiveRoomListener.CreateRoomCallback callback);
